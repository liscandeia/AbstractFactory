 ...
 * @since 18/01/2024 - 11:18
 * <p>
 * Copyright (c) 2023 Lis de Lima. All rights reserved.
 */
public class CarroCelta extends Carro {
    public CarroCelta(String tanqueCombustivel, String cor, int ano) {
        super(tanqueCombustivel, cor, ano);
    }
}
